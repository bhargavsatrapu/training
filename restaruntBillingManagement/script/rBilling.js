...
async function getOrderData() {
    ...
    for (var k in ordeItems) {
        ...
        <td><button class="view-summary" onclick="orderSummary(${k})">visit..</button></td>
    </tr>
        `
...
function orderSummary(k) {
    ...
    modalBody.innerHTML += `<hr><hr>`
    modalBody.innerHTML += `<p class="modal-p1">total payble = ${ordeItems[k].billAmount}</p>`
}
